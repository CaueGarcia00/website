const dadosMembros = {
  sec: [
    ...
    {
      nome: "Marina de Anna Dias Cortes Leite",
      cargo: "General Secretary",
      imagem: "Marina de Anna.JPG",
    },
    {
      nome: "Gabriela Sanches Silva",
      cargo: "General Subsecretary",
      imagem: "Gabriela Sanches.JPG",
    },
  ],
  ...
  ddcr: [
    {
      nome: "Filippe Brasil Mezzena",
      cargo: "Diretoria de Crises",
      imagem: "Filipe Brasil.JPG", 
    },
    {
      nome: "Ian Bentzviller de Almeida",
      cargo: "Diretoria de Crises",
      imagem: "Ian.JPG", 
    },
    
    {
      nome: "Cora Bortoletto Ferreira",
      cargo: "Diretoria de Crises",
      imagem: "Cora.JPG", 
    },
  ],
  ...
  da: [
    {
      ...
      cargo: "Diretória Acadêmica – Revisão",
      imagem: "Aniele.JPG",
    },
    {
